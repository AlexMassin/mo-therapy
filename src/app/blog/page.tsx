...
export const metadata: Metadata = {
  ...
  description: 'Expert insights on sports injuries, physiotherapy, recovery tips, and injury prevention from our licensed professionals. Stay informed about the latest in sports medicine.',
  keywords: [
    'sports injury blog',
    'physiotherapy tips',
    'injury prevention',
  ...
  openGraph: {
    ...
    description: 'Expert insights on sports injuries, recovery, and performance optimization from our licensed healthcare professionals.',
    type: 'website',
  },
};
